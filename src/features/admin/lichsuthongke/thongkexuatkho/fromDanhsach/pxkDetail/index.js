...
DanhSachKienHangXuatKhoAdmin.propTypes = {
    data: PropTypes.array,
};

DanhSachKienHangXuatKhoAdmin.defaultProps = {
    data: null,
}


function DanhSachKienHangXuatKhoAdmin(props) {
...
export default DanhSachKienHangXuatKhoAdmin;